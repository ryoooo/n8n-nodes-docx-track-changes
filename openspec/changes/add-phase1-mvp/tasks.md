...
- [x] 3.1 extractRevisions.ts: オペレーション実装
- [x] 3.2 挿入（insert）履歴の抽出
- [x] 3.3 削除（delete）履歴の抽出
- [x] 3.4 コンテキスト（前後テキスト）オプション対応
- [x] 3.5 サマリー（統計情報）の生成
...
- [x] 5.1 DocxRevisions.node.ts: ノード定義とUI
- [x] 5.2 オペレーション切り替えロジック
- [x] 5.3 バイナリデータハンドリング

## 6. テスト・検証

- [x] 6.1 テスト用docxファイルの作成（履歴・コメント付き） → `sample/nda-meti 2.docx`
- [x] 6.2 Extract Revisionsのユニットテスト
- [x] 6.3 Extract Commentsのユニットテスト
- [x] 6.4 n8n上での動作確認（ビルド成功・統合テスト完了）
